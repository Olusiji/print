	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="{{ route('vendor.dashboard') }}" class="active"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li><a href="{{ route('vendor.jobs') }}" class=""><i class="lnr lnr-briefcase"></i> <span>Jobs</span></a></li>
						<li><a href="{{ route('vendor.profile.edit') }}" class=""><i class="lnr lnr-user"></i> <span>Profile</span></a></li>
						<li><a href="{{ route('vendor.payments') }}" class=""><i class="lnr lnr-user"></i> <span>Payments</span></a></li>
						<li>
							<a href="#subPages" data-toggle="collapse" class="collapsed"><i class="lnr lnr-file-empty"></i> <span>pricing</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="{{ route('vendor.covers') }}" class="">Covers</a></li>
									<li><a href="{{ route('vendor.papers') }}" class="">Papers</a></li>
									<li><a href="page-lockscreen.html" class="">Packaging</a></li>
								</ul>
							</div>
						</li>
					</ul>
